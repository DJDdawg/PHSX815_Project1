...
For the Null Hypothesis $H_{0}$, $\vec{p} = $ {$\frac{1}{6}, \frac{1}{6}, \frac{1}{6}, \frac{1}{6}, \frac{1}{6}, \frac{1}{6},$}.

And for the Alternative Hypothesis $H_{}$, $\vec{p} = $ {$0.3, 0.1, 0.3, 0.1, 0.1, 0.1$}.
